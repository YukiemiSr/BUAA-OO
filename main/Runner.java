...
public class Runner {
    ...
    public Runner(Class<? extends Person> personClass, Class<? extends Network> networkClass,
        ...
        messageConstructor0 =
            this.messageClass.getConstructor(int.class, int.class, Person.class, Person.class);
        messageConstructor1 =
            this.messageClass.getConstructor(int.class, int.class, Person.class, Group.class);
...
//                throw new AssertionError();
    ...
    private HashMap<Integer, HashMap<Integer, Integer>> getModifyRelationOKData(
        ArrayList<String> cmdList, boolean needCheck) throws Exception {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (cnt < 0 || cnt > n - 1) {
                throw new Exception(
                    "person " + idList.get(i) + ": The number of acquaintances is invalid!");
            }
            ...
            for (int j = 1; j <= cnt; j++) {
                ...
                if (!ret.containsKey(id) || id == idList.get(i) || map.containsKey(id)) {
                    throw new Exception(
                        "person " + idList.get(i) + " acquaintance " + id + " is invalid!");
                }
                map.put(id, value);
            }
        }
    ...
    private void addMessage()
        ...
        if (type == 0) {
            ...
            Message message =
                this.messageConstructor0.newInstance(id, socialValue, person1, person2);
            try {
